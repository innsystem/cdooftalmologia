...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('/galerias/favicon_cdo.ico') }}" type="image/x-icon">
                        ...
                        <div class="header-inner">
                            <div class="de-flex">
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="{{ url('/') }}">
                                            <img class="logo-main" src="{{ asset('/galerias/logo_cdo.png') }}" alt="Logomarca CDO Oftalmologia">
                                            <img class="logo-scroll" src="{{ asset('/galerias/logo_cdo.png') }}" alt="Logomarca CDO Oftalmologia">
                                            <img class="logo-mobile" src="{{ asset('/galerias/logo_cdo.png') }}" alt="Logomarca CDO Oftalmologia">
                                        </a>
                                    </div>
                                    <!-- logo close -->
                                </div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                        <div class="widget">
                            ...
                            @else
                            contato@cdooftalmologia.com.br
                            @endif
                        </div>
                    </div>
                </div>
