...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'meta_title', 'value' => 'Bem-vindos | CDO Oftalmologia'],
            ['key' => 'meta_keywords', 'value' => 'negócios, serviços, clientes'],
            ['key' => 'meta_description', 'value' => ''],
            ['key' => 'script_head', 'value' => ''],
            ['key' => 'script_body', 'value' => ''],
            ['key' => 'site_name', 'value' => 'CDO Oftalmologia'],
            ['key' => 'site_proprietary', 'value' => 'CDO Oftalmologia LTDA'],
            ['key' => 'site_document', 'value' => '12.345.678/0001-90'],
            ['key' => 'site_email', 'value' => 'contato@cdooftalmologia.com.br'],
